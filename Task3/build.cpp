...
// Create 4 holes as UF_NEGATIVE extrusions.
...
// Must be called inside UF_initialize() / UF_terminate().
int BuildAssembly(void)
{
    ...
    // Positions for holes on R_PITCH circle (every 90°)
    const double positions[4][2] = {
        {  R_PITCH,  0.0 },
        {  0.0,  R_PITCH },
        { -R_PITCH,  0.0 },
    ...
    // ================================================================
    // 1. prokladka1 — Z=119, ⌀140 / ⌀50, 4 мм вверх
    // ================================================================
    ...
    // ================================================================
    // 2. zaglushka — Z=123, ⌀140, 16 мм вверх, выточка ⌀55×5 мм
    // ================================================================
    ...
    // ================================================================
    // 3. prokladka2 — Z=0, 160×160 R20, 5 мм вниз, 4×⌀15, центр ⌀80
    // ================================================================
    {
    ...
    // ================================================================
    // 4. korpus_flanetz1 + korpus_patrubok — Z=0, 160×160 R20, 14 мм вверх,
    //    4×⌀15, центр ⌀50, труба ⌀60/⌀50 вверх
    // ================================================================
    {
    ...
    // ================================================================
    // 5. korpus_patrubok — труба ⌀60/⌀50, Z=0 → +105, поперечное ⌀35
    // ================================================================
    {
    ...
    // ================================================================
    // 6. korpus_flanetz2 — Z=119, ⌀140/⌀50, 25 мм вниз, UF_POSITIVE,
    //    4×⌀13 на R=50
    // ================================================================
    {
    ...
    // ================================================================
    // 7. bobyshka — касательная плоскость Y=30, ⌀35/⌀21, внутрь 30 /
    //    наружу 15 мм (оба UF_POSITIVE), затем вычитание полости трубы
    // ================================================================
    {
    ...
    // ================================================================
    // 8. flanetz — Z=-5, 160×160, 25 мм вниз, 4×⌀15, цилиндр ⌀80 вниз
    //    (UF_POSITIVE), отв. R=25.3
    // ================================================================
    {
